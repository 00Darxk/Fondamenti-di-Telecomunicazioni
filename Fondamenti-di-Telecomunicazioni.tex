...
\begin{center}
    \begin{tikzpicture}[scale=2]
        ...
        \draw[-](-2.5,0.5)--(-2,0.5)--(-1.5,0.5)--(-1.5,-0.5)--(-0.5,-0.5)--(-0.5,0.5)--(0.5,0.5)--(0.5,-0.5)--(1.5,-0.5)--(2,-0.5)--(2,0.5)--(2.5,0.5);
        \node[above right]at(0,0.5){$1$};
...
\begin{gather*}
    ...
    x(t-t_0)=\displaystyle\sum_{k=-\infty}^{+\infty}c_ke^{i\frac{2\pi k(t-t_0)}{T}}=\sum_{k=-\infty}^{+\infty}\left(c_ke^{i\frac{2\pi kt}{T}}+c_ke^{-i\frac{2\pi kt_0}{T}}\right)\\
\end{gather*}
...
\begin{gather*}
    y(t)=x(t)\cos\displaystyle\left(\frac{2\pi t}{T}\right)=x(t)\left[\frac{e^{i\frac{2\pi t}{T}}+e^{-i\frac{2\pi t}{T}}}{2}\right]\\
    \displaystyle\sum_{k=-\infty}^{+\infty}c_ke^{i\frac{2\pi kt}{T}}\frac{e^{i\frac{2\pi t}{T}}+e^{-i\frac{2\pi t}{T}}}{2}\\
    y(t)=\displaystyle\frac{1}{2}\sum_{k=-\infty}^{+\infty}c_ke^{i\frac{2\pi (k+1)t}{T}}+\frac{1}{2}\sum_{k=-\infty}^{+\infty}c_ke^{i\frac{2\pi (k-1)t}{T}}\\
    y(t)=\displaystyle\frac{1}{2}\left(\sum_{m=-\infty}^{+\infty}c_{m-1}e^{i\frac{2\pi mt}{T}}+\sum_{m=-\infty}^{+\infty}c_{m+1}e^{i\frac{2\pi mt}{T}}\right)\\
...
\begin{gather*}
    c_k=\displaystyle\frac{1}{T}\int_{-\frac{T}{2}}^{\frac{T}{2}}\frac{d}{dt}x(t)e^{-i\frac{2\pi kt}{T}}dt=
...
\begin{gather*}
    ...
    \cancelto{0}{-i\int_{-\frac{T}{4}}^{\frac{T}{4}}\cos\left(\frac{2\pi t}{T}\right)\sin\left(\frac{4\pi kt}{T}\right)dt}\\
    \displaystyle\frac{4}{T}\int_{0}^{\frac{T}{4}}\cos\left(\frac{2\pi t}{T}\right)\cos\left(\frac{4\pi kt}{T}\right)dt
\end{gather*}
Poiché è una funzione pari, l'integrale corrisponde al doppio dell'integrale su solo una metà dell'intervallo di integrazione. 


Per le formule di prostaferesi si ottiene:
\begin{gather*}
...
L'argomento del seno, lo rende tale che assumi solo valori $\pm1$. Per valori pari di $k$, uno assume valore $1$, mentre l'altro $-1$, analogamente per valori dispari di $k$. 
I due seni assumono sempre valori discordi. Si possono esprimere come: 
\begin{gather*}
...
Un qualsiasi segnale reale si può esprimere come: 
\begin{gather*}
...
\begin{gather*}
    ...
    c_0+\sum_{k=-\infty}^{+\infty}2\rho_k\cos(\phi_k)\cos\left(\frac{2\pi kt}{T}\right)-2\rho_k\sin(\phi_k)\sin\left(\frac{2\pi kt}{T}\right)\\
