...
\begin{equation*}
    \displaystyle e^{i\frac{2\pi kt}{T}}=\sin\left(\frac{2\pi kt}{T}\right)+i\sin\left(\frac{2\pi kt}{T}\right)
\end{equation*}
...
\begin{gather*}
    d_k=\displaystyle\frac{1}{T}\int_{-\frac{T}{2}}^{\frac{T}{2}}x(t-t_0)e^{-i\frac{2\pi kt}{T}}dT\to\int_{-\frac{T}{2}-t_0}^{\frac{T}{2}-t_0}x(\tau)e^{-i\frac{2pi kt_0}{T}}e^{-i\frac{2\pi k\tau}{T}}d\tau\\
...
\begin{equation*}
    y(t)=x(t)\cdot e^{i\frac{2\pi nt}{T}}=\displaystyle\sum_{K=-\infty}^{+\infty}c_ke^{i\frac{2pi kt}{T}}e^{i\frac{2\pi nt}{T}}
\end{equation*}
...
Ciò equivale a traslare i coefficienti di Fourier, associando i coefficienti $c_k$ ad armoniche di ordine $k+n$. 
