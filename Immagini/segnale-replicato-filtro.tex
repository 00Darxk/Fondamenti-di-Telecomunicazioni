...
\begin{tikzpicture}[scale=1.2]
    ...
    \draw[-,ultra thick, blue](1.75,0)--(1.75,1)--(-1.75,1)node[above, black]{$H(f)$}--(-1.75,0);

    \filldraw[black](1.75,0)node[below]{$\displaystyle\frac{1}{2T}$}circle(0.5pt);
    \filldraw[black](-1.75,0)node[below]{$\displaystyle-\frac{1}{2T}$}circle(0.5pt);
    \filldraw[black](3.5,0)node[below]{$\displaystyle\frac{1}{T}$}circle(0.5pt);
    \filldraw[black](-3.5,0)node[below]{$-\displaystyle\frac{1}{T}$}circle(0.5pt);
    \filldraw[black](5.25,0)node[below]{$\displaystyle\frac{3}{2T}$}circle(0.5pt);
    \filldraw[black](-5.25,0)node[below]{$\displaystyle-\frac{3}{2T}$}circle(0.5pt);
